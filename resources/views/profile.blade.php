    ...
    @foreach ($komting as $komting )
            ...
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                    style="background-image: url('{{ asset("storage/profile/" . ($komting->foto ?? "default_siluet.png")) }}')"></div>

                <h1 class="text-3xl font-bold pt-8 lg:pt-0">{{ $komting->username }}</h1>
                <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-purple-500 opacity-25"></div>
                <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                    <svg class="h-4 fill-current text-purple-700 pr-4" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                            d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z" />
                    </svg> Komting {{ $komting->user_class }}
                </p>
                <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                    ...
                    </svg> Universitas Negeri Medan
                </p>
                <p class="pt-8 text-sm"></p>

                <div class="pt-12 pb-8">
                    <a href="https://wa.me/62{{ $komting->no_telp }}" target="_blank" class="bg-purple-700 hover:bg-purple-900 text-white font-bold py-2 px-4 rounded-full">
				         Chat In Whatsapp
                    </a>
                </div>
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    <a class="link" href="#" data-tippy-content="@facebook_handle">
                        <svg class="h-6 fill-current text-gray-600 hover:text-purple-700" role="img" viewBox="0 0 24 24"
                    ...
                    <a class="link" href="#" data-tippy-content="@youtube_handle">
                        <svg class="h-6 fill-current text-gray-600 hover:text-purple-700" role="img"
        ...
        <div class="w-full lg:w-2/5">
            <img src="{{ asset('storage/profile/' . ($komting->foto ?? 'default_siluet.png')) }}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
