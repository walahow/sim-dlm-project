...
<nav class="bg-white border-b border-gray-200 px-4  dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
    <div class="flex flex-wrap justify-between items-center">
      <div class="flex justify-start items-center">
        <button
          ...
          class="  hover:bg-purple-500 p-2 mr-2 text-gray-600 rounded-lg cursor-pointer md:hidden hover:text-gray-900  focus:bg-purple-400 dark:focus:bg-gray-700 focus:ring-2 focus:ring-gray-100 dark:focus:ring-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
        >
          <svg
            aria-hidden="true"
            class=" hover:text-white w-6 h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        <a class=" flex items-center justify-between mr-4">
          <svg version="1.1" viewBox="0 0 2000 2000" width="60" height="60" xmlns="http://www.w3.org/2000/svg">
          ...
          <span class="self-center text-2xl font-semibold whitespace-nowrap  dark:text-white">SIM</span>
        </a>

        {{-- search section --}}

        <form action="{{ route('dashboard') }}" method="GET" class="hidden md:block md:pl-2">
      ...
      <div class="flex items-center lg:order-2">
        ...
        data-drawer-toggle="drawer-navigation"
        aria-controls="drawer-navigation"
        class="  hover:text-white hover:bg-purple-500 p-2 mr-1 text-gray-500 rounded-lg md:hidden  dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
      >
  ...
  class="relative text-base p-2 mr-1 text-gray-500  focus:ring-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 dark:focus:ring-gray-600"
>
  <span class="sr-only">View notifications</span>
  <!-- Bell icon -->
  <svg
    class=" rounded-full w-8 h-8 text-gray-400  dark:text-white  hover:text-white hover:bg-purple-500"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width="40"
    height="40"
  ...
  >
    4
        ...
        <button
          type="button"
          class="flex mx-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-purple-500 dark:focus:ring-gray-600"
          id="user-menu-button"
          aria-expanded="false"
        ...
        >
          ...
          <img
            ...
            src="{{ asset('storage/profile/' . (Auth::user()->foto ?? 'siluet_default.png')) }}"
            alt="user photo"
          />
        </button>
        <!-- Dropdown menu -->
  ...
  <li>
    <a
      href="/negotiate/{{ Auth::user()->id }}"
      class="grid grid-cols-2 py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white"
    >
      My profile
    </a>
  </li>
